...
为了进行团队共同开发，我们将项目放在 Github 上进行管理：[saltyfishyjk/PyToDo: PyToDo is a GUI project based mainly on Python (github.com)](https://github.com/saltyfishyjk/PyToDo)。三人分别在本地进行开发，使用 git 进行版本管理，在 Github 上进行进度同步，大大提高了开发效率。

![image-Github](Report/image-20220814194956651.png)
