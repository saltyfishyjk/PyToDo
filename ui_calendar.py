from PySide6.QtWidgets import (QGridLayout,QHBoxLayout, QFrame, QPlainTextEdit, QVBoxLayout, QTextEdit)
from PySide6.QtCore import Qt

    
def calendar_ui_init(self):

    self.calendar_layout = QVBoxLayout(self.new_page)
    self.calendar_layout.setObjectName(u"calendar_layout")
    self.CalendarTitle = QTextEdit(self.new_page)
    ...
    self.calendar_layout.addWidget(self.CalendarTitle)

    self.calendar_week = QHBoxLayout()
    self.calendar_week.setObjectName(u"calendar_week")
    self.calendar_Sun = QTextEdit(self.new_page)
    ...
    self.calendar_Mon = QTextEdit(self.new_page)
    ...
    self.calendar_Thue = QTextEdit(self.new_page)
    ...
    self.calendar_Wed = QTextEdit(self.new_page)
    ...
    self.calendar_Thur = QTextEdit(self.new_page)
    ...
    self.calendar_Fri = QTextEdit(self.new_page)
    ...
    self.calendar_Sat = QTextEdit(self.new_page)
    ...
    self.calendar15 = QPlainTextEdit(self.new_page)
    self.calendar15.setObjectName(u"calendar15")
    self.calendar15.setStyleSheet("QMenu{background:#6272a4;}")
