...
"#topLogo {\n"
"	background-color: rgb(33, 37, 43);\n"
"	border-image: url(:/images/images/images/inboxtodo.png);\n"
...
"}")
        ...
        self.btn_arrange.setStyleSheet(u"background-image: url(:/icons/images/icons/arrange.png);")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/images/icons/cil-library-add.png", QSize(), QIcon.Normal, QIcon.Off)
...
" }")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 301, 218))
...
" QScrollBar:horizontal { background: rgb(52, 59, 72); }")
        ...
        self.arrange_page = QWidget()
        self.arrange_page.setObjectName(u"calendar_page")
        self.stackedWidget.addWidget(self.arrange_page)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.titleLeftApp.setText(QCoreApplication.translate("MainWindow", u"PyTODO", None))
        ...
        self.btn_matrix.setText(QCoreApplication.translate("MainWindow", u"TODO Quadrant", None))
        self.btn_pic.setText(QCoreApplication.translate("MainWindow", u"History", None))
...
#if QT_CONFIG(tooltip)
        self.settingsTopBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Create", None))
#endif // QT_CONFIG(tooltip)
